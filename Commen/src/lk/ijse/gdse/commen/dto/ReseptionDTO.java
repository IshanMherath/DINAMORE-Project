...
public class ReseptionDTO extends SuperDTO {
    ...
    public ReseptionDTO(int receptionistID, String receptionistF_Name, String receptionistAddress, int receptionistTel, int age, String city) {
