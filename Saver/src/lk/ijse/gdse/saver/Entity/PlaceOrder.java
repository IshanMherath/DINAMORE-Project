...
public class PlaceOrder {
    ...
    public PlaceOrder(int orederID, int customerID, int receptionistID, int itemCode, String orderDate, String orderTakeTime, String orderIssuTime, int orderQty) {
    ...
    public PlaceOrder(int orederID, int customerID, int receptionistID, int itemCode, String orderIssuTime, int orderQty) {
        this.orederID = orederID;
        this.customerID = customerID;
        this.receptionistID = receptionistID;
        this.itemCode = itemCode;
